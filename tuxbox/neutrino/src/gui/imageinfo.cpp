...
void CImageInfo::paintRevisionInfos(int y_startposition)
{
	...
	paintContent(font_small, xpos+x_offset_large, y_startposition, getModulVersion("","$Revision$").c_str());
 ...
 * 	special characters like "$" or the complete string "Revision" ->> eg: "$Revision$" becomes "1.xx", 
 ...
 * 	some examples:
 * 	getModulVersion("Version: ","$Revision$")	 returns "Version: 1.x"	
 * 	getModulVersion("v.","$Revision$")			 returns "v.1.x"
 *  	getModulVersion("","$Revision$")		 		 returns "1.x"
 */
